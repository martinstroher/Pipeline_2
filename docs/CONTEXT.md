...
- Output: `output/refined/validate_taxonomy.csv`, `output/refined/validate_relations.csv`, `output/refined/validate_edits.csv`, `output/refined/validate_instances.csv`, `output/refined/validate_minted_properties.csv`, `output/refined/validate_defined_classes.csv`
