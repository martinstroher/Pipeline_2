...
| `studies/expert_eval.yaml` | Cross-domain workbook prose: 65 instruction-sheet rows for the eight modular sheets. Edit only if evaluation anchors or calibration examples differ. |
